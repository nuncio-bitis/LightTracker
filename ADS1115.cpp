...
void ADS1115::showConfigRegister() {
    ...
    printf("ConfigRegister: 0x%04X\n", configRegister);
      ...
      mSerial.println(">>> ADS1115_SERIAL_DEBUG >>>");

      mSerial.print("Register is:");
      mSerial.println(configRegister,BIN);

      mSerial.print("OS:\t");
      mSerial.println(getValueFromBits(configRegister,
