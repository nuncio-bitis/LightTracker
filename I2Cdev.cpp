...
int8_t I2Cdev::readBytes(uint8_t regAddr, uint8_t length, uint8_t *data)
{
    ...
    mSerial.print("I2CDEV_SERIAL_DEBUG: I2C (0x");
    mSerial.print(mDevAddr, HEX);
    mSerial.print(") reading ");
    mSerial.print(length, DEC);
    mSerial.print(" bytes from 0x");
    mSerial.print(regAddr, HEX);
    mSerial.println("...");
#endif
...
#ifdef I2CDEV_SERIAL_DEBUG
    mSerial.print("I2CDEV_SERIAL_DEBUG: Done (");
    mSerial.print(count, DEC);
    mSerial.println(" bytes read).");
#endif
...
bool I2Cdev::writeBytes(uint8_t regAddr, uint8_t length, uint8_t *data)
{
    ...
    mSerial.print("I2CDEV_SERIAL_DEBUG: I2C (0x");
    mSerial.print(mDevAddr, HEX);
    mSerial.print(") writing ");
    mSerial.print(length, DEC);
    mSerial.print(" bytes to 0x");
    mSerial.print(regAddr, HEX);
    mSerial.println("...");
#endif
...
#ifdef I2CDEV_SERIAL_DEBUG
    mSerial.println("I2CDEV_SERIAL_DEBUG: Done.");
#endif
